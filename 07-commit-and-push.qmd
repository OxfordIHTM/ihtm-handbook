...
7.2.1 Tick the box beside the file that has changed to stage the changes.

7.2.2 Write a commit message in the `Commit message` dialog box. In the commit message, describe the changes that you made.
    
7.2.3 Click on the `Commit` button.
    
7.2.4 Click on the `Push` button.

## Initiate a pull request

7.3.1 Click on the **branches** link from your repository

![](images/pull_request1.png)

7.3.2 Click on the **Make pull request** link on the appropriate branch

![](images/pull_request2.png)

7.3.3 Enter a title for your pull request

![](images/pull_request3.png)

Make the titel as short but as informative as possible

7.3.4 Add further description about the pull request (optional) and then click on **Create pull request** button

---
output-file: getting-acquainted.html
---

# Getting acquainted with R {#sec-getting-acquainted}
...
fem <- read.table(
  "https://raw.githubusercontent.com/OxfordIHTM/teaching_datasets/refs/heads/main/fem.dat",
  header = TRUE
)
```
